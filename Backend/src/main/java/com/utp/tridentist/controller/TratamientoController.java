...
import com.utp.tridentist.service.TratamientoService;
...
public class TratamientoController {
    ...
    public ResponseEntity<Tratamiento> getById(@PathVariable Integer id) {
        Optional<Tratamiento> entity = service.findById(id);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Tratamiento> update(@PathVariable Integer id, @RequestBody Tratamiento entityDetails) {
